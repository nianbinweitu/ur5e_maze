...
CUBE_URDF_PATH = "ur_e_description/urdf/target.urdf"
...
class UR5Sim(object):
    ...
    def load_cube(self):
        # 设置随机坐标
        cube_x = 0.5
        cube_y = (random() - 0.5) * 0.3
        cube_z = (random() - 0.5) * 0.3 + 0.4
        cube = pybullet.loadURDF(CUBE_URDF_PATH, [cube_x, cube_y, cube_z], [0, 0, 0, 1], useFixedBase=True)
        return cube
    ...
    def add_gui_sliders(self):
        ...
        self.sliders.append(pybullet.addUserDebugParameter("Z", 0.1, 1, 0.4))
